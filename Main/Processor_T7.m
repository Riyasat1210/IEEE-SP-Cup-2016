...
skew = skewness(sig);
kurt = log10(kurtosis(sig));


[dontcare ind_sig]=find(sig);
[L0 L1]=Linear_Regrassion( ind_sig,sig );


feature = [MEAN v d_range vA9 vD1 vD2 vD3 vD4 vD5...
                vD6 vD7 vD8 vD9 A log10(C) maxxf pval skew kurt log10(abs(L0)) log10(abs(L1))];
...
VarName = {'MEAN', 'v', 'd_range', 'vA9' ,'vD1' ,'vD2' ,'vD3' ,'vD4' ,'vD5',...
                'vD6', 'vD7', 'vD8', 'vD9', 'A1','A2','A3','A4','log_C',...
                 };
